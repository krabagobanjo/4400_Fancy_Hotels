...
class UpdateReservationPage3(Frame):
	def __init__(self, parent, presenter):
		...
		Button(self, text = "Submit", font = Main_Font, relief = RAISED).grid(row = len(n) + 3, column = 5)
...
class CancelReservationPage2(Frame):
	def __init__(self, parent, presenter):
		...
		Button(self, text = "Cancel", font = Main_Font, relief = RAISED).grid(row = len(n) + 5, column = 4)
...
class ViewReviewPage1(Frame):
	def __init__(self, parent, presenter):
		...
		locations.configure(width = 20, font = Main_Font)
		locations.grid(row = 2, column = 1)
		Button(self, text = "Check Reviews", font = Main_Font, relief = RAISED, command=lambda: presenter.show_frame(ViewReviewPage2)).grid(row = 3, column = 2)
